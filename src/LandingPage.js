    ...
    <div className="">
      <div className="flex flex-col items-center">
        <div className="w-full flex flex-col md:flex-row justify-center">
          <div className="w-full md:w-1/5 text-center my-5 py-5 px-4">
            <h1 className="font-bold text-2xl">This is a prototype journey, showcasing a series of prototypes related to the Charity Data Works project.</h1>
            <p className="font-base text-xl text-justify my-2 py-2">
              ...
              <br /><br /> You can explore our prototypes and concepts through the navigation buttons at the bottom of the screen or the navigation buttons at the top of the screen. 
            </p>
          </div>
          <div className="w-full md:w-3/4 flex justify-center items-center my-5 py-5">
            <img
