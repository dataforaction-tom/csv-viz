  ...
  return (
    <div className="flex flex-col items-center">
      <div className="w-4/5 my-5 py-5 text-center">
        <h1 className="font-bold text-4xl mb-4 text-left">This is a prototype journey, showcasing a series of prototypes related to the Charity Data Works project.</h1>
